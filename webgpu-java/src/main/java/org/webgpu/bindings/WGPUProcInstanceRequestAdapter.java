...
public class WGPUProcInstanceRequestAdapter {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcInstanceRequestAdapter.Function.class,
            "apply", $DESC);
     ...
     */
    public static MemorySegment invoke(MemorySegment funcPtr, SegmentAllocator alloc, MemorySegment instance,
