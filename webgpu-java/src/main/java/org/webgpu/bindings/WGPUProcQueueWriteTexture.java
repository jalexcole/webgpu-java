...
public class WGPUProcQueueWriteTexture {
    ...
    public interface Function {
        void apply(MemorySegment queue, MemorySegment destination, MemorySegment data, long dataSize,
                MemorySegment dataLayout, MemorySegment writeSize);
    }
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcQueueWriteTexture.Function.class, "apply",
            $DESC);
     ...
     */
    public static void invoke(MemorySegment funcPtr, MemorySegment queue, MemorySegment destination, MemorySegment data,
