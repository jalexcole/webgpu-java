...
public class WGPUProcRenderPassEncoderSetBindGroup {
    ...
    public interface Function {
        void apply(MemorySegment renderPassEncoder, int groupIndex, MemorySegment group, long dynamicOffsetCount,
    ...
    private static final MethodHandle UP$MH = webgpu_h
            .upcallHandle(WGPUProcRenderPassEncoderSetBindGroup.Function.class, "apply", $DESC);
     ...
     */
    public static void invoke(MemorySegment funcPtr, MemorySegment renderPassEncoder, int groupIndex,
