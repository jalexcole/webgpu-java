...
public class _opaque_pthread_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_POINTER.withName("__cleanup_stack"),
            MemoryLayout.sequenceLayout(8176, webgpu_h.C_CHAR).withName("__opaque")).withName("_opaque_pthread_t");
    ...
    private static final AddressLayout __cleanup_stack$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("__cleanup_stack"));

    /**
     * Layout for field:
     * {@snippet lang = c : * struct __darwin_pthread_handler_rec *__cleanup_stack
     * }
     */
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * char __opaque[8176]
     * }
     */
