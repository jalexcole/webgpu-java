...
public class WGPUChainedStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            webgpu_h.C_POINTER.withName("next"),
            webgpu_h.C_INT.withName("sType"),
            MemoryLayout.paddingLayout(4)).withName("WGPUChainedStruct");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * const struct WGPUChainedStruct *next
     * }
     */
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUSType sType
     * }
     */
