...
public class WGPUComputePassTimestampWrites {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_INT.withName("endOfPassWriteIndex")).withName("WGPUComputePassTimestampWrites");
    ...
    private static final long beginningOfPassWriteIndex$OFFSET = $LAYOUT
            .byteOffset(groupElement("beginningOfPassWriteIndex"));
