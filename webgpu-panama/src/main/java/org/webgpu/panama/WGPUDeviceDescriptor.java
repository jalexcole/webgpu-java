...
public class WGPUDeviceDescriptor {
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * const WGPUFeatureName *requiredFeatures
     * }
     */
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * const WGPULimits *requiredLimits
     * }
     */
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUQueueDescriptor defaultQueue
     * }
     */
    ...
    private static final GroupLayout deviceLostCallbackInfo$LAYOUT = (GroupLayout) $LAYOUT
            .select(groupElement("deviceLostCallbackInfo"));

    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUDeviceLostCallbackInfo deviceLostCallbackInfo
     * }
     */
    ...
    private static final long deviceLostCallbackInfo$OFFSET = $LAYOUT
            .byteOffset(groupElement("deviceLostCallbackInfo"));
    ...
    public static void deviceLostCallbackInfo(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, deviceLostCallbackInfo$OFFSET,
                deviceLostCallbackInfo$LAYOUT.byteSize());
    }

    private static final GroupLayout uncapturedErrorCallbackInfo$LAYOUT = (GroupLayout) $LAYOUT
            .select(groupElement("uncapturedErrorCallbackInfo"));
    ...
    private static final long uncapturedErrorCallbackInfo$OFFSET = $LAYOUT
            .byteOffset(groupElement("uncapturedErrorCallbackInfo"));
    ...
    public static void uncapturedErrorCallbackInfo(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, uncapturedErrorCallbackInfo$OFFSET,
                uncapturedErrorCallbackInfo$LAYOUT.byteSize());
    }
