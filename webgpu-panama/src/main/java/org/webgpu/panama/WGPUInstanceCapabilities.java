...
public class WGPUInstanceCapabilities {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_INT.withName("timedWaitAnyEnable"),
            MemoryLayout.paddingLayout(4),
            webgpu_h.C_LONG.withName("timedWaitAnyMaxCount")).withName("WGPUInstanceCapabilities");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUBool timedWaitAnyEnable
     * }
     */
    ...
    private static final OfLong timedWaitAnyMaxCount$LAYOUT = (OfLong) $LAYOUT
            .select(groupElement("timedWaitAnyMaxCount"));

    /**
     * Layout for field:
     * {@snippet lang = c : * size_t timedWaitAnyMaxCount
     * }
     */
