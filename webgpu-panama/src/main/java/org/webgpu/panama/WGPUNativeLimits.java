...
public class WGPUNativeLimits {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_INT.withName("maxNonSamplerBindings")).withName("WGPUNativeLimits");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUChainedStructOut chain
     * }
     */
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * uint32_t maxPushConstantSize
     * }
     */
    ...
    private static final OfInt maxNonSamplerBindings$LAYOUT = (OfInt) $LAYOUT
            .select(groupElement("maxNonSamplerBindings"));

    /**
     * Layout for field:
     * {@snippet lang = c : * uint32_t maxNonSamplerBindings
     * }
     */
