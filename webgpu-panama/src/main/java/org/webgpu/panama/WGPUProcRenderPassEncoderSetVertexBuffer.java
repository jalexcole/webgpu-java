 ...
 * }
 */
public final class WGPUProcRenderPassEncoderSetVertexBuffer {

    private WGPUProcRenderPassEncoderSetVertexBuffer() {
    ...
    private static final MethodHandle UP$MH = webgpu_h
            .upcallHandle(WGPUProcRenderPassEncoderSetVertexBuffer.Function.class, "apply", $DESC);
     ...
     */
    public static void invoke(MemorySegment funcPtr, MemorySegment renderPassEncoder, int slot, MemorySegment buffer,
