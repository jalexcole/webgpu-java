...
public class WGPUPushConstantRange {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            webgpu_h.C_LONG_LONG.withName("stages"),
            webgpu_h.C_INT.withName("start"),
            webgpu_h.C_INT.withName("end")).withName("WGPUPushConstantRange");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUShaderStage stages
     * }
     */
