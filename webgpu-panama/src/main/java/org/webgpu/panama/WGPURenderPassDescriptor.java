...
public class WGPURenderPassDescriptor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_POINTER.withName("timestampWrites")).withName("WGPURenderPassDescriptor");
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * const WGPUChainedStruct *nextInChain
     * }
     */
    ...
    private static final OfLong colorAttachmentCount$LAYOUT = (OfLong) $LAYOUT
            .select(groupElement("colorAttachmentCount"));

    /**
     * Layout for field:
     * {@snippet lang = c : * size_t colorAttachmentCount
     * }
     */
    ...
    private static final AddressLayout colorAttachments$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("colorAttachments"));

    /**
     * Layout for field:
     * {@snippet lang = c : * const WGPURenderPassColorAttachment *colorAttachments
     * }
     */
    ...
    private static final AddressLayout depthStencilAttachment$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("depthStencilAttachment"));
    ...
    private static final long depthStencilAttachment$OFFSET = $LAYOUT
            .byteOffset(groupElement("depthStencilAttachment"));
    ...
    private static final AddressLayout occlusionQuerySet$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("occlusionQuerySet"));

    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUQuerySet occlusionQuerySet
     * }
     */
    ...
    private static final AddressLayout timestampWrites$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("timestampWrites"));

    /**
     * Layout for field:
     * {@snippet lang = c : * const WGPURenderPassTimestampWrites *timestampWrites
     * }
     */
