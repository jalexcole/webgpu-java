...
public class WGPURequestAdapterOptions {
    ...
    private static final OfInt featureLevel$LAYOUT = (OfInt) $LAYOUT.select(groupElement("featureLevel"));

    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUFeatureLevel featureLevel
     * }
     */
     ...
     * }
     */
    public static int featureLevel(MemorySegment struct) {
        return struct.get(featureLevel$LAYOUT, featureLevel$OFFSET);
    }
     ...
     * }
     */
    public static void featureLevel(MemorySegment struct, int fieldValue) {
        struct.set(featureLevel$LAYOUT, featureLevel$OFFSET, fieldValue);
    }
    ...
    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUPowerPreference powerPreference
     * }
     */
    ...
    private static final OfInt forceFallbackAdapter$LAYOUT = (OfInt) $LAYOUT
            .select(groupElement("forceFallbackAdapter"));

    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUBool forceFallbackAdapter
     * }
     */
    ...
    private static final AddressLayout compatibleSurface$LAYOUT = (AddressLayout) $LAYOUT
            .select(groupElement("compatibleSurface"));

    /**
     * Layout for field:
     * {@snippet lang = c : * WGPUSurface compatibleSurface
     * }
     */
