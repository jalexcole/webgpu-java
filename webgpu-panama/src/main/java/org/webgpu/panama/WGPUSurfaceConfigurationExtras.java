...
public class WGPUSurfaceConfigurationExtras {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_INT.withName("desiredMaximumFrameLatency"),
            MemoryLayout.paddingLayout(4)).withName("WGPUSurfaceConfigurationExtras");
    ...
    private static final OfInt desiredMaximumFrameLatency$LAYOUT = (OfInt) $LAYOUT
            .select(groupElement("desiredMaximumFrameLatency"));

    /**
     * Layout for field:
     * {@snippet lang = c : * uint32_t desiredMaximumFrameLatency
     * }
     */
    ...
    private static final long desiredMaximumFrameLatency$OFFSET = $LAYOUT
            .byteOffset(groupElement("desiredMaximumFrameLatency"));
