...
public class WGPUSurfaceSourceSwapChainPanel {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            ...
            webgpu_h.C_POINTER.withName("panelNative")).withName("WGPUSurfaceSourceSwapChainPanel");
    ...
    private static final AddressLayout panelNative$LAYOUT = (AddressLayout) $LAYOUT.select(groupElement("panelNative"));

    /**
     * Layout for field:
     * {@snippet lang = c : * void *panelNative
     * }
     */
     ...
     * }
     */
    public static MemorySegment panelNative(MemorySegment struct) {
        return struct.get(panelNative$LAYOUT, panelNative$OFFSET);
    }
     ...
     * }
     */
    public static void panelNative(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(panelNative$LAYOUT, panelNative$OFFSET, fieldValue);
    }
