 ...
 * }
 */
public final class WGPUProcAdapterInfoFreeMembers {

    private WGPUProcAdapterInfoFreeMembers() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcAdapterInfoFreeMembers.Function.class, "apply", $DESC);
