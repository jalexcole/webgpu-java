 ...
 * }
 */
public final class WGPUProcCommandEncoderAddRef {

    private WGPUProcCommandEncoderAddRef() {
     ...
     */
    public static MemorySegment allocate(WGPUProcCommandEncoderAddRef.Function fi, Arena arena) {
