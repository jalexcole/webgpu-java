 ...
 * }
 */
public final class WGPUProcDeviceCreateBindGroup {

    private WGPUProcDeviceCreateBindGroup() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceCreateBindGroup.Function.class, "apply", $DESC);
