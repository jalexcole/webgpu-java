 ...
 * }
 */
public final class WGPUProcDeviceCreateBuffer {

    private WGPUProcDeviceCreateBuffer() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceCreateBuffer.Function.class, "apply", $DESC);
