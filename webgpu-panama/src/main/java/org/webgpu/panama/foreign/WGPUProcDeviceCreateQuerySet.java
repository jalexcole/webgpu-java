 ...
 * }
 */
public final class WGPUProcDeviceCreateQuerySet {

    private WGPUProcDeviceCreateQuerySet() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceCreateQuerySet.Function.class, "apply", $DESC);
