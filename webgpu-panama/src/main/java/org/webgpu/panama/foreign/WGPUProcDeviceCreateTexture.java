 ...
 * }
 */
public final class WGPUProcDeviceCreateTexture {

    private WGPUProcDeviceCreateTexture() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceCreateTexture.Function.class, "apply", $DESC);
