 ...
 * }
 */
public final class WGPUProcDeviceHasFeature {

    private WGPUProcDeviceHasFeature() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceHasFeature.Function.class, "apply", $DESC);
