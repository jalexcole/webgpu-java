...
/**
 * {@snippet lang=c :
 * typedef void (*WGPUProcDeviceSetLabel)(WGPUDevice, WGPUStringView)
 * }
 */
public final class WGPUProcDeviceSetLabel {

    private WGPUProcDeviceSetLabel() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcDeviceSetLabel.Function.class, "apply", $DESC);
