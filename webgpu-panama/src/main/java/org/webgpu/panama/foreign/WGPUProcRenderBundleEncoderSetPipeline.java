 ...
 * }
 */
public final class WGPUProcRenderBundleEncoderSetPipeline {

    private WGPUProcRenderBundleEncoderSetPipeline() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcRenderBundleEncoderSetPipeline.Function.class, "apply", $DESC);
