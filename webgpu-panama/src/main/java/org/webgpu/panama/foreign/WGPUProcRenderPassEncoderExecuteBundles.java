 ...
 * }
 */
public final class WGPUProcRenderPassEncoderExecuteBundles {

    private WGPUProcRenderPassEncoderExecuteBundles() {
    ...
    private static final MethodHandle UP$MH = webgpu_h.upcallHandle(WGPUProcRenderPassEncoderExecuteBundles.Function.class, "apply", $DESC);
