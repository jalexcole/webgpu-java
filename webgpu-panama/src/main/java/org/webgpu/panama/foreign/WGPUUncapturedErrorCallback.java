 ...
 * }
 */
public final class WGPUUncapturedErrorCallback {

    private WGPUUncapturedErrorCallback() {
     ...
     */
    public static MemorySegment allocate(WGPUUncapturedErrorCallback.Function fi, Arena arena) {
