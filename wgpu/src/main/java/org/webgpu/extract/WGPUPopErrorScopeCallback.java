...
public class WGPUPopErrorScopeCallback {
    ...
    public interface Function {
        void apply(int status, int type, MemorySegment message, MemorySegment userdata1, MemorySegment userdata2);
    }
     ...
     */
    public static MemorySegment allocate(WGPUPopErrorScopeCallback.Function fi, Arena arena) {
