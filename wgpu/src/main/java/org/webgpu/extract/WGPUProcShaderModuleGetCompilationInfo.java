...
public class WGPUProcShaderModuleGetCompilationInfo {
    ...
    public interface Function {
        MemorySegment apply(MemorySegment shaderModule, MemorySegment callbackInfo);
    }
    ...
    private static final MethodHandle UP$MH = webgpu_h
            .upcallHandle(WGPUProcShaderModuleGetCompilationInfo.Function.class, "apply", $DESC);
     ...
     */
    public static MemorySegment invoke(MemorySegment funcPtr, SegmentAllocator alloc, MemorySegment shaderModule,
